...
create_option: [DEFAULT] {
    CHARACTER SET [=] charset_name /*carácter set por defecto, caracter de codificacion que se utilizara UTF-8, UTF-16*/
...
)ENGINE=InooDB; /*INNODB permite muchas transacciones, mas robusto*/
```
...
```sql
INSERT INTO nombreTabla(columana1, columna2, columna3 ....)
